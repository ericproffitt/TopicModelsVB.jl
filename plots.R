...
# 12 x 8
df = data.frame(x=c(1,2,3.5,4.5,6,7), label=c('gpuLDA', 'LDA', 'gpuCTM', 'CTM', 'gpuCTPF', 'CTPF'), Seconds=c(55, 404, 392, 1974, 48, 831), Processor=rep(c('Intel Iris Plus Graphics 640', '2.3 GHz Dual-Core Intel Core i5'), 3))
