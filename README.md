...
Markov chain Monte Carlo methods are slow but consistent, given enough time MCMC will fit the exact model exactly. Contrarily, variational inference is fast but inconsistent, as one must approximate distributions in order to ensure tractability.
