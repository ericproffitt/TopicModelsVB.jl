...
To use the Full Computer Magazine dataset, you will need to unzip the two document files and then stack the data from both in a single file (cmagdocs1.txt on top).
