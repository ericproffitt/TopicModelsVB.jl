...
As you may have noticed, the dynamic topic model is *extremely* computationally intensive, hopefully GPGPU support will ameliorate this problem to at least some degree.  However it is likely that running a DTM model on an industry-sized dataset will always require more computational power than can be provided by a standard personal computer.
